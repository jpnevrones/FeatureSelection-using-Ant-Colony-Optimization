...
public class AFS_antcol extends AntColony
{
    ...
    public AFS_antcol(AntGraph graph, int ants, int iterations,String t_name,double threshold)
    {
    ...
    protected Ant[] createAnts(AntGraph graph, int nAnts)
    {
        ...
        {
            ant[i] = new AFS_ant((int)(graph.nodes() * ran.nextDouble()),this, wpage_name,weight_threshold);
        }
